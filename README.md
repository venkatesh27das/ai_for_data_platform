...
The logical-model canvas is a visual shell in this iteration. Source upload, structured artefacts, mappings, DQ rules, model operations, full agent implementations, and export generation are intentionally deferred.
