...
export function BuildPage() {
  ...
  return (
    <div className="workspace-screen">
      ...
      <WorkspaceKpis>
        <article className="workspace-kpi workspace-kpi--progress"><Ring tone="blue" value={running ? 74 : 68} /><div><small>Assembly Progress</small><strong>{running ? "74%" : "68%"}</strong><span className="trend--up">In Progress</span></div></article>
      ...
      <div className="build-workspace-grid">
        ...
        <WorkspacePanel action={<TextAction>View all →</TextAction>} className="mapping-review-panel" title="Recommendations & Mapping Review">
